...
const tabs: Array<{ id: SidebarTab; label: string; icon: ReactNode }> = [
	...
	},
	{
		...
		label: "Agent logs",
		icon: (
			<path d="M48 56h160v16H48Zm0 48h160v16H48Zm0 48h96v16H48Zm120 0h40v16h-40Zm-120 48h128v16H48Z" />
		),
	},
	{
		id: "tools",
		label: "Tool tests",
		icon: (
			<path d="M96 40h64v24H96Zm-24 40h112v24H72Zm-24 40h160v88a8 8 0 0 1-8 8H56a8 8 0 0 1-8-8Zm32 32v16h96v-16Zm0 32v16h64v-16Z" />
		),
	},
	{
		id: "chat",
		label: "Chat",
		icon: (
			<path d="M40 56a24 24 0 0 1 24-24h128a24 24 0 0 1 24 24v88a24 24 0 0 1-24 24h-64l-56 48v-48h-8a24 24 0 0 1-24-24Zm40 32v16h96V88Zm0 40v16h64v-16Z" />
		),
	},
];
...
export function Sidebar({
	...
	return (
		<aside
			className="absolute left-3 top-3 z-[4] flex h-[calc(100%-24px)] w-[min(380px,calc(100vw-24px))] flex-col overflow-hidden rounded-lg border border-[#0b1720]/55 bg-[#101820]/86 text-[#eef4ea] shadow-[0_18px_54px_rgba(5,12,16,0.28)] backdrop-blur"
			aria-label="Townbase sidebar"
		>
