...
export function ModePanel({ mode, onSetMode, onRunPopulationStep, isRunning }: ModePanelProps) {
  return (
    <section className="rounded-md bg-[#17201d]/72 p-3" aria-label="Simulation mode">
      <div className="mb-2">
        <h2 className="text-sm font-semibold text-[#f7fbf2]">Simulation</h2>
        <p className="mt-1 text-xs text-[#cdd8c4]/70">Control population stepping.</p>
      </div>
